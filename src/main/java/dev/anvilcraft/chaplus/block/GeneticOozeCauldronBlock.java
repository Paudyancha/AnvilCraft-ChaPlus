...
public class GeneticOozeCauldronBlock extends Layered4LevelCauldronBlock {
    public GeneticOozeCauldronBlock(Properties properties) {
        super(properties, AddonInteractionMaps.GENETIC_OOZE);
    }
